...
laboratory_name = '精细化工研究室'
institute_id = 46
laboratory_id = 214
img_url_head = None
partition_num = '0411'
start_urls = [
                # 'http://www.lac.dicp.ac.cn/Members.htm',
                # 'http://www.asym.dicp.ac.cn/yjdw.htm',
                'http://www.lbcs.dicp.ac.cn/Members.htm',
                # ''
              ]

# a_s_xpath_str = '//tr[2]//div[@class="piclist"][1]//li[position()<9]'
# a_s_xpath_str = '//div[@id="vsb_content"]//table[1]//tr[2]/td[1]//a'
a_s_xpath_str = '//div[@class="tr-ri"]/div[@class="tupian"]'

# target_div_xpath_str = '//div[@class="content2"]'
# target_div_xpath_str = '//div[@id="vsb_content"]'
target_div_xpath_str = '//form[@name="_newscontent_fromname"]|//div[@class="tr-ri"]'
...
spider = SpecialSpider(
                   ...
                   institute_id=institute_id,
                   laboratory_id=laboratory_id,
                   name_filter_re=r'(?:副)?研究员.*|(?:正)?(?:高级)?(?:机械)(?:电子)工程师.*|博(?:士)?.*|实验师|项目.*',
