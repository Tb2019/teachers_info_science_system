...
laboratory_name = '仪器分析化学研究室'
institute_id = 46
laboratory_id = 213
img_url_head = None
partition_num = '0411'
start_urls = [
                # 'http://www.anacen.dicp.ac.cn/rcdw/gzry.htm',
                # 'http://www.105.dicp.ac.cn/rcdw/gzry.htm',
                'http://www.sensor.dicp.ac.cn/yjdw1/znzg.htm',
              ]

# a_s_xpath_str = '//div[@class="main worker"]/dl/dd/a'
# a_s_xpath_str = '//div[@id="vsb_content"]//tr//td//a'
a_s_xpath_str = '//ul[@class=" list-paddingleft-2"]/li/a'
...
spider = ReCrawler(
                   ...
                   institute_id=institute_id,
                   laboratory_id=laboratory_id,
                   name_filter_re=r'(?:副)?研究员|(?:正)?(?:高级)?(?:机械)(?:电子)工程师|博(?:士)?后|实验师',
