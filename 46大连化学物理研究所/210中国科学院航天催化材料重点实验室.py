...
laboratory_name = '中国科学院航天催化材料重点实验室'
institute_id = 46
laboratory_id = 210
img_url_head = None
partition_num = '0411'
start_urls = [
                'http://www.taozhang.dicp.ac.cn/yjry/yjsfzr.htm',
                'http://www.taozhang.dicp.ac.cn/yjry/yjzzz.htm',
                'http://www.taozhang.dicp.ac.cn/yjry/yjy.htm',
                'http://www.taozhang.dicp.ac.cn/yjry/bsxlzzyjry.htm'
              ]

a_s_xpath_str = '//div[@class="piclist"]//li//a'
