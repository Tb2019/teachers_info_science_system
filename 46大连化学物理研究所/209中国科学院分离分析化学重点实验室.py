...
laboratory_name = '中国科学院分离分析化学重点实验室'
institute_id = 46
laboratory_id = 209
img_url_head = None
partition_num = '0411'
start_urls = [
                'http://www.chromatography.dicp.ac.cn/yjdw1/yjy.htm',
                'http://www.chromatography.dicp.ac.cn/yjdw1/yjy/3.htm',
                'http://www.chromatography.dicp.ac.cn/yjdw1/yjy/2.htm',
                'http://www.chromatography.dicp.ac.cn/yjdw1/yjy/1.htm'
              ]

a_s_xpath_str = '//div[@class="z_list"]//li/a'
