...
laboratory_name = '中国科学院电化学储能技术工程实验室'
institute_id = 46
laboratory_id = 211
img_url_head = None
partition_num = '0411'
start_urls = [
                'http://www.energystorage.dicp.ac.cn/bmgk/kydw.htm#'
              ]

a_s_xpath_str = '//div[@class="s-team"]//div[@class="team-two-1"]//a[@href!="#"]'
target_div_xpath_str = '//form[@name="_newscontent_fromname"]|//div[@class="main_conRC"]'
