...
laboratory_name = '能源催化转化全国重点实验室'
institute_id = 46
laboratory_id = 204
img_url_head = None
partition_num = '0411'
start_urls = [
                'https://nklc.dicp.ac.cn/rcdw1/zgjkyry.htm',
                'https://nklc.dicp.ac.cn/rcdw1/zgjkyry/6.htm',
                'https://nklc.dicp.ac.cn/rcdw1/zgjkyry/5.htm',
                'https://nklc.dicp.ac.cn/rcdw1/zgjkyry/4.htm',
                'https://nklc.dicp.ac.cn/rcdw1/zgjkyry/3.htm',
                'https://nklc.dicp.ac.cn/rcdw1/zgjkyry/2.htm',
                'https://nklc.dicp.ac.cn/rcdw1/zgjkyry/1.htm'
              ]

a_s_xpath_str = '//div[@class="teams"]//li//a'
        ...
        for a in a_s:
            ...
            if name:
                ...
                if not img.startswith('http'):
                    img = parse.urljoin('https://nklc.dicp.ac.cn/', img)
            else:
