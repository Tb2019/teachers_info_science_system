...
laboratory_name = '大连化学物理研究所'
institute_id = 46
laboratory_id = 239
img_url_head = None
partition_num = '0411'
start_urls = [
                'https://dicp.cas.cn/rcdw_1/yjy/',
                'https://dicp.cas.cn/rcdw_1/yjy/index_1.html',
                'https://dicp.cas.cn/rcdw_1/yjy/index_2.html',
                'https://dicp.cas.cn/rcdw_1/yjy/index_3.html',
                'https://dicp.cas.cn/rcdw_1/yjy/index_4.html'
              ]

a_s_xpath_str = '//div[@class="row teams"]//li/a'
target_div_xpath_str = '//div[@class="secondarydetailbox"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//div[@class="txtinfo"]/h4/text()')
            if name:
                name = ''.join(name)
