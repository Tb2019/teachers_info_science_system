...
institute_name = '南京地质古生物研究所'
laboratory_name = '古生物学与油气地层应用重点实验室'
institute_id = 75
laboratory_id = 298
img_url_head = None
partition_num = '025'
start_urls = [
                'http://www.sklps.cn/syscy/gdry/',
                'http://www.sklps.cn/syscy/gdry/index_1.html',
                'http://www.sklps.cn/syscy/gdry/index_2.html',
                'http://www.sklps.cn/syscy/gdry/index_3.html',
                'http://www.sklps.cn/syscy/gdry/index_4.html',
                'http://www.sklps.cn/syscy/gdry/index_5.html',
              ]

a_s_xpath_str = '//*[@id="content"]/li/div/div[2]'
# target_div_xpath_str = '//div[@class="col_l"]|//div[@class="col-md-9"]|//div[@class="comp-personnel-details-01"]'
target_div_xpath_str = '//div[@class="comp-personnel-details-01"]|//div[@class="col_l"]'
