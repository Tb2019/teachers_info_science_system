...
laboratory_name = '轻量化实验室'
institute_id = 80
laboratory_id = 311
img_url_head = None
partition_num = '0512'
start_urls = [
                'http://mnss.sinano.ac.cn/65d1565ae138233a1c715669/imageList',
                'http://mnss.sinano.ac.cn/65d156a4e138233a1c71566a/imageList',
                'http://mnss.sinano.ac.cn/65d156c4e138233a1c71566b/imageList',
              ]
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        info = re.findall(r'{id:"(.*?)",menuId.*?name:"(.*?)"', index_page, re.S)
        for id in info:
            name = id[1]
            link = url + '/' + id[0]
            yield name, link
