...
institute_name = '微小卫星创新研究院'
laboratory_name = '微小卫星创新研究院'
institute_id = 71
laboratory_id = 283
img_url_head = None
partition_num = '021'
start_urls = [
                'https://microsate.cas.cn/yajsjy/dsjs/xxytxgc/',
              ]

a_s_xpath_str = '//div[@class="new-tables"]//tbody/tr/td[1]//a'
target_div_xpath_str = '//div[@class="peopleInfo"]'
