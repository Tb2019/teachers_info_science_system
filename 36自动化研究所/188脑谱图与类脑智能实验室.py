...
laboratory_name = '脑谱图与类脑智能实验室.py'
institute_id = 36
laboratory_id = 188
img_url_head = None
partition_num = '010'
start_urls = [
                # 'https://braincog.ai/people/#enmeng.lu',
                # 'http://www.brainnetome.org/people/faculty/',
                'http://www.brainnetome.org/people/VisitingProfessorship/',
                # ''
              ]

# a_s_xpath_str = '//div[contains(@class, "d-flex justify-content-center align-items-center flex-wrap people-card-container")]//a'
# a_s_xpath_str = '//tr//td[2]//a'
a_s_xpath_str = '//tr//td[2]//a'
