...
laboratory_name = '紫东太初大模型研究中心'
institute_id = 36
laboratory_id = 189
img_url_head = None
partition_num = '010'
start_urls = [
                'https://taichu.ia.ac.cn/team/yjdw/zyjy',
                'https://taichu.ia.ac.cn/team/yjdw/fyjy',
              ]

a_s_xpath_str = '//div[@class="flex flex-wrap py-8 gap-4"]/div/div'
