...
laboratory_name = '自动化研究所'
institute_id = 36
laboratory_id = 191
img_url_head = None
partition_num = '010'
start_urls = [
                'http://ia.cas.cn/rcdw/yjy/',
                'http://ia.cas.cn/rcdw/yjy/index_1.html',
                'http://ia.cas.cn/rcdw/yjy/index_2.html',
                'http://ia.cas.cn/rcdw/yjy/index_3.html',
                'http://ia.cas.cn/rcdw/yjy/index_4.html',
                'http://ia.cas.cn/rcdw/fyjy/',
                'http://ia.cas.cn/rcdw/fyjy/index_1.html',
                'http://ia.cas.cn/rcdw/fyjy/index_2.html',
                'http://ia.cas.cn/rcdw/fyjy/index_3.html',
                'http://ia.cas.cn/rcdw/fyjy/index_4.html'
              ]

a_s_xpath_str = '//ul[@id="content"]/li/a'
target_div_xpath_str = '//div[@class="gunius-detail"]'
