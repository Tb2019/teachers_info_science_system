...
laboratory_name = '中国科学院分子影像重点实验室'
institute_id = 36
laboratory_id = 185
img_url_head = 'http://www.3dmed.net/'
partition_num = '010'
start_urls = [
                'http://www.3dmed.net/syszr/index.htm',
                'http://www.3dmed.net/fzyxqy/index.htm',
                'http://www.3dmed.net/yxdsjfx/index.htm',
                'http://www.3dmed.net/znyljqr/index.htm'
              ]

a_s_xpath_str = '//ul[@id="list-team"]/li//a[not(contains(@href, "java"))]'
