...
institute_name = '华南植物园'
laboratory_name = '生态与环境科学研究中心'
institute_id = 90
laboratory_id = 329
img_url_head = None
partition_num = '020'
start_urls = [
                'https://scbg.cas.cn/rc/yjy/',
                'https://scbg.cas.cn/rc/fyjy/',
              ]

a_s_xpath_str = '//div[@class="comp-personnel-list-04 pep-list pep-list2"][2]//li/div/a'
target_div_xpath_str = '//div[@class="comp-personnel-details-02 pep-xilan"]'
