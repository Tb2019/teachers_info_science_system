...
laboratory_name = '流固耦合系统力学重点实验室'
institute_id = 1
laboratory_id = 64
img_url_head = None
partition_num = '010'
start_urls = [
                # 'https://lmfs.imech.cas.cn/rc/ky/yjy/',
                # 'https://lmfs.imech.cas.cn/rc/ky/fyjy/',
                'https://lmfs.imech.cas.cn/rc/ky/zlyjy/'
                # ''
              ]

a_s_xpath_str = '//div[@class="rytp-box"]/ul/li/a[not(contains(@href, "javascript"))]'
