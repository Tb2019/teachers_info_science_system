# -*- coding: utf-8 -*-
# todo:王柳的邮箱加密；彭庆多一个逗号，宋恒旭多一个逗号
import re
from crawler import ReCrawler

institute_name = '力学研究所'
laboratory_name = '非线性力学国家重点实验室'
institute_id = 3
laboratory_id = 17
img_url_head = None
partition_num = '010'
start_urls = [
                'http://www.lnm.imech.cas.cn/kydw/yjry/',
                'http://www.lnm.imech.cas.cn/kydw/jsry/',
                'http://www.lnm.imech.cas.cn/kydw/xsgw/',
                'http://www.lnm.imech.cas.cn/kydw/glry/'
              ]

a_s_xpath_str = '//div[@class="erji_main"]/div[@class="erji_sp "]//div[@class="TRS_Editor"]//td//a|//div[@class="er_sp_cont margintop15"]//td/a[2]'
