...
laboratory_name = '真菌学国家重点实验室'
institute_id = 26
laboratory_id = 166
img_url_head = None
partition_num = '010'
start_urls = [
                'http://mycolab.im.ac.cn/yjdw/',
                # '',
                # '',
                # ''
              ]

a_s_xpath_str = '//div[@class="pic-list"]/dl/dd/a'
target_div_xpath_str = '//div[@class="content"]|//div[@class="text_wram"]'
