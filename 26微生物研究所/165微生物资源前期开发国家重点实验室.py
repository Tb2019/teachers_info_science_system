...
laboratory_name = '微生物资源前期开发国家重点实验室'
institute_id = 26
laboratory_id = 165
img_url_head = None
partition_num = '010'
start_urls = [
                'https://im.cas.cn/sklmr/yjdw/',
                # '',
                # '',
                # ''
              ]

a_s_xpath_str = '//div[@class="fl w100 wswsys_images_text wswsys_ry_list"]/div/dl/dd//a'
target_div_xpath_str = '//div[@class="fl w100 mart15 wswsys_content"]|//div[@class="text"]'
