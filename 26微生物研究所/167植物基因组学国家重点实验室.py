...
institute_name = '微生物研究所'
laboratory_name = '植物基因组学国家重点实验室'
institute_id = 26
laboratory_id = 167
img_url_head = None
partition_num = '010'
start_urls = [
                'https://im.cas.cn/jgsz2018/yjtx/zwjyzxgjzdsys/201811/t20181109_5168609.html',
                # '',
                # '',
                # ''
              ]

a_s_xpath_str = '//div[@class="TRS_Editor"]//table//tr//center//tr/td[2]'
target_div_xpath_str = '//div[@class="text_wram"]'
...
class SpecialSpider(ReCrawler):
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            ...
            if name:
                name = ''.join(name)
                name = re.search(r'研究组长：(.*?)\s', name, re.S).group(1)
