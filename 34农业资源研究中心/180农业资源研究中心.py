...
institute_name = '农业资源研究中心'
laboratory_name = '农业资源研究中心'
institute_id = 34
laboratory_id = 180
img_url_head = None
partition_num = '010'
start_urls = [
                'https://sjziam.cas.cn/rcdw/yszj/',
                'https://sjziam.cas.cn/rcdw/yjy/',
                'https://sjziam.cas.cn/rcdw/yjy/index_1.html',
                'https://sjziam.cas.cn/rcdw/yjy/index_2.html',
                'https://sjziam.cas.cn/rcdw/fyjy/',
                'https://sjziam.cas.cn/rcdw/fyjy/index_1.html'
              ]

a_s_xpath_str = '//ul[@id="content"]/li//a'
target_div_xpath_str = '//div[@class="row temp02-wrap-content"]'
