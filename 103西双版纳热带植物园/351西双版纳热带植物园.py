...
institute_name = '西双版纳热带植物园'
laboratory_name = '西双版纳热带植物园'
institute_id = 103
laboratory_id = 351
img_url_head = None
partition_num = '0691'
start_urls = [
                'https://xtbg.cas.cn/2022/rcdw/yjy/',
                'https://xtbg.cas.cn/2022/rcdw/gcs/',
                'https://xtbg.cas.cn/2022/rcdw/sys/',
                'https://xtbg.cas.cn/2022/rcdw/qtrc/',
              ]

a_s_xpath_str = '//div[@class="nei_yjy_ul"]/a'
target_div_xpath_str = '//div[@class="nei_yjy_info wow slideInUp"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('./div[@class="nei_yjy_li_p"]/p[1]/text()')
            if name:
                name = ''.join(name)
