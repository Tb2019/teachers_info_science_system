...
laboratory_name = '高分子与复合材料实验室'
institute_id = 73
laboratory_id = 287
img_url_head = None
partition_num = '0574'
start_urls = [
                'https://polymer.nimte.ac.cn/chenpeng.html',
                'https://polymer.nimte.ac.cn/fxz.html',
                'https://polymer.nimte.ac.cn/zwg.html',
                'https://polymer.nimte.ac.cn/zhangyonggang.html',
                'https://polymer.nimte.ac.cn/zhujin.html',
                'https://polymer.nimte.ac.cn/zhangjian.html',
                'https://polymer.nimte.ac.cn/yaoqiang.html',
                'https://polymer.nimte.ac.cn/yuhaibin.html',
                'https://polymer.nimte.ac.cn/liufu.html',
                'https://polymer.nimte.ac.cn/wangzhen.html',
                'https://polymer.nimte.ac.cn/zhanghao.html',
              ]

a_s_xpath_str = '//*[@id="list"]/table/tbody/tr[1]'
