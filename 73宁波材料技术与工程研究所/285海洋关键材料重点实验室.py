...
institute_name = '宁波材料技术与工程研究所'
laboratory_name = '海洋关键材料重点实验室'
institute_id = 73
laboratory_id = 285
img_url_head = None
partition_num = '0574'
start_urls = [
                'http://marinelab.nimte.cas.cn/team/academician/',
                'http://marinelab.nimte.cas.cn/team/director/',
                'http://marinelab.nimte.cas.cn/team/nationaltalents/',
                'http://marinelab.nimte.cas.cn/team/nationaltalents/',
                'http://marinelab.nimte.cas.cn/team/nationaltalents/index_1.html',
                'http://marinelab.nimte.cas.cn/team/pmtalents/',
                'http://marinelab.nimte.cas.cn/team/researchgroup/',
                'http://marinelab.nimte.cas.cn/team/researchgroup/index_1.html',
                'http://marinelab.nimte.cas.cn/team/researchgroup/index_2.html',
                'http://marinelab.nimte.cas.cn/team/researchgroup/index_3.html',
                'http://marinelab.nimte.cas.cn/team/researchgroup/index_4.html',
                'http://marinelab.nimte.cas.cn/team/assistant/'
              ]

a_s_xpath_str = '//div[@class="people"]/div[@class="item"]/div[@class="text"]'
target_div_xpath_str = '//div[@class="news_page"]|//body'
# target_div_xpath_str = '//div[@class="news_page"]|//td[@id="content"]|//div[@class="rc"]/div[@class="html"]|//div[class="nr"]/div[@class=""html]|//div[@class="b-pinfo"]|//div[@id="main"]'
...
spider = SpecialSpider(
                   ...
                   institute_id=institute_id,
                   laboratory_id=laboratory_id,
                   name_filter_re=r'院士|(?:副)?研究员.*?|实验(?:室|师).*?|(?:副)?主任.*?|(?:高级)?工程师.*?',
