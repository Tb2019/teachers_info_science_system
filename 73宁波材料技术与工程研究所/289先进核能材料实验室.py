...
laboratory_name = '先进核能材料实验室'
institute_id = 73
laboratory_id = 289
img_url_head = None
partition_num = '0574'
start_urls = [
                'https://fine-lab.nimte.ac.cn/supervisor.html',
                'https://fine-lab.nimte.ac.cn/kepin.html',
                'https://fine-lab.nimte.ac.cn/researcher.html',
                'https://fine-lab.nimte.ac.cn/member.html',
              ]

a_s_xpath_str = '//*[@id="right"]//p[@class="teamlist"]'
...
spider = SpecialSpider(
                   ...
                   institute_id=institute_id,
                   laboratory_id=laboratory_id,
                   name_filter_re=r'院士|(?:春蕾副|副|项目|客聘|助理)?研究员|中科院.*|(?:访问|)?教授|(?:高级)工程师|高级助理|博士后.*',
