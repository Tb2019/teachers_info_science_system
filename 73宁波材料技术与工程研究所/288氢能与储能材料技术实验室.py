...
laboratory_name = '氢能与储能材料技术实验室'
institute_id = 73
laboratory_id = 288
img_url_head = None
partition_num = '0574'
start_urls = [
                'https://h2-lab.nimte.ac.cn/staff.html'
              ]

a_s_xpath_str = '//div[@class="team2"]/a'
target_div_xpath_str = '//div[@class="rCon"]'
