...
laboratory_name = '生物医学与健康工程研究所'
institute_id = 94
laboratory_id = 338
img_url_head = None
partition_num = '0755'
start_urls = [
                'https://www.siat.ac.cn/yjjg/ygs2016/kydw_112345/'
              ]

a_s_xpath_str = '//div[@class="teams"]/ul/li/a'
target_div_xpath_str = '//div[@class="xlmain left"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('./div[@class="info"]/div[@class="title"]/text()')
            if name:
                name = ''.join(name)
