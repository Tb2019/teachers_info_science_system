...
laboratory_name = '脑认知与脑疾病研究所'
institute_id = 94
laboratory_id = 337
img_url_head = None
partition_num = '0755'
start_urls = [
                # 'http://bcbdi.siat.ac.cn/index.php/member/index.shtml#desc',
                # 'http://bcbdi.siat.ac.cn/index.php/member2/index.shtml#desc',
                'http://bcbdi.siat.ac.cn/index.php/MemberAss/index.shtml#desc',
              ]

# a_s_xpath_str = '//div[@class="field-item even"]/h3/following-sibling::p[2]/a[1]'
a_s_xpath_str = '//div[@class="field-items"]/div/a'
target_div_xpath_str = '//div[@class="main-content-inner"]'
