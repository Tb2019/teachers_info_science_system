...
institute_name = '东北地理与农业生态研究所'
laboratory_name = '中国科学院湿地生态与环境重点实验室'
institute_id = 55
laboratory_id = 249
img_url_head = None
partition_num = '0431'
start_urls = [
                'https://neigae.cas.cn/rcjs/zg/',
                'https://neigae.cas.cn/rcjs/fg/'
              ]

a_s_xpath_str = '//div[@class="col-md-r"]/div[@class="link-name"][4]//a'
target_div_xpath_str = '//div[@class="mt25"]'
