...
laboratory_name = '中国科学院寒旱区陆面过程与气候变化重点实验室'
institute_id = 111
laboratory_id = 366
img_url_head = None
partition_num = '0931'
start_urls = [
                'http://lpcc.careeri.cas.cn/lpcc_teams/lpcc_team_people/'
              ]

a_s_xpath_str = '//*[@id="Profile"]/table[3]/tbody/tr/td[4]/table[2]/tbody/tr/td/table[1]/tbody//tbody//tr[2]//a'
target_div_xpath_str = '//*[@id="Profile"]/table[3]/tbody/tr/td[4]/table[2]/tbody/tr/td/table/tbody/tr[3]/td'
