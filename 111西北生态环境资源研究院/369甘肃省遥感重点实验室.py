...
laboratory_name = '甘肃省遥感重点实验室'
institute_id = 111
laboratory_id = 369
img_url_head = None
partition_num = '0931'
start_urls = [
                'http://rslab.nieer.ac.cn/kytd/index.html',
              ]

a_s_xpath_str = '//ul[@class="row peoplelist"]/li/a'
target_div_xpath_str = '//div[@class="textxl nrhei xilan-content-main"]'
