...
laboratory_name = '甘肃省油气资源勘探与评价重点实验室'
institute_id = 111
laboratory_id = 370
img_url_head = None
partition_num = '0931'
start_urls = [
                'http://www.lig.cas.cn/kydw/yjy/',
                'http://www.lig.cas.cn/kydw/fy/',
                'http://www.lig.cas.cn/kydw/kzjs/',
                'http://www.lig.cas.cn/kydw/keygg/',
              ]

a_s_xpath_str = '//ul[@class="main_list_img"]/li/p/a'
target_div_xpath_str = '//div[@class="neirong"]'
