...
laboratory_name = '中国科学院内陆河流域生态水文重点实验室'
institute_id = 111
laboratory_id = 365
img_url_head = None
partition_num = '0931'
start_urls = [
                'http://cw.casnw.net//wwwroot/nlh/rcpy/dsjs/index.shtml'
              ]

a_s_xpath_str = '//div[@class="pure-u-3-4"]//tr[@align="left"]//a'
target_div_xpath_str = '//div[@class="listcontent"]'
