...
institute_name = '西北生态环境资源研究院'
laboratory_name = '冰冻圈科学国家重点实验室'
institute_id = 111
laboratory_id = 363
img_url_head = None
partition_num = '0931'
start_urls = [
                'http://www.sklcs.ac.cn/yanjiuyuan/',
                'http://www.sklcs.ac.cn/yanjiuyuan/list_53_2.html',
                'http://www.sklcs.ac.cn/yanjiuyuan/list_53_3.html'
              ]

a_s_xpath_str = '//div[@class="listrightshow"]/ul/li[2]/a'
target_div_xpath_str = '//div[@class="main_right"]|//div[@class="listrightshow"]|//div[@id="content"]'
