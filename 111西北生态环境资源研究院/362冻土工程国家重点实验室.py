...
laboratory_name = '冻土工程国家重点实验室'
institute_id = 111
laboratory_id = 362
img_url_head = None
partition_num = '0931'
start_urls = [
                'http://sklfse.nieer.ac.cn/zgchannel/index.html',
                'http://sklfse.nieer.ac.cn/zgchannel/index_1.html'
              ]

a_s_xpath_str = '//div[@class="row staff"]//li//div[@class="boxstyle"]'
