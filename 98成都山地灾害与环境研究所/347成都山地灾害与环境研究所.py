...
institute_name = '成都山地灾害与环境研究所'
laboratory_name = '成都山地灾害与环境研究所'
institute_id = 98
laboratory_id = 347
img_url_head = None
partition_num = '028'
start_urls = [
                # 'https://imde.cas.cn/yjdw_118068/zgry/',
                # 'https://imde.cas.cn/yjdw_118068/qnyjy/',
                'https://imde.cas.cn/yjdw_118068/zgry_145549/',
              ]

# a_s_xpath_str = '//div[@class="TRS_Editor"]/table//tr//a'
# a_s_xpath_str = '//div[@class="ue_table"]/table//tr//a'
a_s_xpath_str = '//div[@class="TRS_PreExcel TRS_PreAppend"]/table//tr//a'
target_div_xpath_str = '//div[@class="erji_sp"]'
