...
institute_name = '数学与系统科学研究院计算数学与科学工程计算研究所'
laboratory_name = '数学与系统科学研究院计算数学与科学工程计算研究所'
institute_id = 16
laboratory_id = 124
img_url_head = None
partition_num = '010'
start_urls = [
                'https://www.cc.ac.cn/lists/27.html',
              ]

a_s_xpath_str = '//div[@class="listStyle  fyyjy"]/ul/li/div//a'
