...
institute_name = '地质与地球物理研究所'
laboratory_name = '院深地资源装备技术工程实验室'
institute_id = 20
laboratory_id = 144
img_url_head = None
partition_num = '010'
start_urls = [
                'http://www.igg.cas.cn/jgsz/kyxt/201706/t20170616_4813315.html',
                # '',
                # '',
                # ''
              ]

a_s_xpath_str = '//td[@width="723"]//a[contains(@href, "html")]'
