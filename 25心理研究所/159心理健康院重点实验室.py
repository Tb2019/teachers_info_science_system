...
institute_name = '心理研究所'
laboratory_name = '心理健康院重点实验室'
institute_id = 25
laboratory_id = 159
img_url_head = None
partition_num = '010'
start_urls = [
                'http://www.psych.cas.cn/jkzdsys/201202/t20120216_3441399.html?randid=0.7358094289526862',
                # '',
                # '',
                # ''
              ]

a_s_xpath_str = '//div[@id="main-cont"]//a'
target_div_xpath_str = '//div[@class="nlist01"]'
