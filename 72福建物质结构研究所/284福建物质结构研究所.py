...
institute_name = '福建物质结构研究所'
laboratory_name = '福建物质结构研究所'
institute_id = 72
laboratory_id = 284
img_url_head = None
partition_num = '0591'
start_urls = [
                'https://fjirsm.cas.cn/yjsjy/zs/dsjj/bssds/',
                'https://fjirsm.cas.cn/yjsjy/zs/dsjj/sssds/'
              ]

a_s_xpath_str = '//div[@class="ue_table"]//tr/td//a'
target_div_xpath_str = '//div[@class="newconcon"]'
