...
institute_name = '植物研究所'
laboratory_name = '系统与进化植物学国家重点实验室'
institute_id = 23
laboratory_id = 147
img_url_head = None
partition_num = '010'
start_urls = [
                'https://ib.cas.cn/2019gb/yjdw2019/yjzz2019/',
                # '',
                # '',
                # ''
              ]

a_s_xpath_str = '//div[@class="secondarydetailbox bgbai1"]/div[@class="row staff"][1]//li//div[@class="txtinfo"]//a'
target_div_xpath_str = '//div[contains(@class, "secondarydetailbox")]'
