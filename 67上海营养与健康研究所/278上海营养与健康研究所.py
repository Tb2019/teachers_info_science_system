...
institute_name = '上海营养与健康研究所'
laboratory_name = '上海营养与健康研究所'
institute_id = 67
laboratory_id = 278
img_url_head = None
partition_num = '021'
start_urls = [
                'http://www.sinh.cas.cn/rcdw/qtyjzz/',
                'http://www.sinh.cas.cn/rcdw/zktdfzr/',
                'http://www.sinh.cas.cn/rcdw/qnyjy/'
              ]

a_s_xpath_str = '//ul[@class="row"]/li/div/div[@class="gunius-info"]'
