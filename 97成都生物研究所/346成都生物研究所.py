...
institute_name = '成都生物研究所'
laboratory_name = '成都生物研究所'
institute_id = 97
laboratory_id = 346
img_url_head = None
partition_num = '028'
start_urls = [
                'https://cib.cas.cn/rcdw/yjy/index.html',
                'https://cib.cas.cn/rcdw/yjy/index_1.html',
                'https://cib.cas.cn/rcdw/yjy/index_2.html',
                'https://cib.cas.cn/rcdw/yjy/index_3.html',
                'https://cib.cas.cn/rcdw/yjy/index_4.html',
                'https://cib.cas.cn/rcdw/fyjy/',
                'https://cib.cas.cn/rcdw/fyjy/index_1.html',
                'https://cib.cas.cn/rcdw/fyjy/index_2.html',
                'https://cib.cas.cn/rcdw/fyjy/index_3.html',
                'https://cib.cas.cn/rcdw/fyjy/index_4.html'
              ]

a_s_xpath_str = '//div[@class="zyk_cent"]//tr//a'
target_div_xpath_str = '//div[@class="middle_yjybg01"]'
