...
laboratory_name = '中国科学院微观界面物理与探测重点实验室'
institute_id = 62
laboratory_id = 273
img_url_head = None
partition_num = '021'
start_urls = [
                'http://ipat.sinap.cas.cn/yjdw/201405/t20140520_234183.html'
              ]

a_s_xpath_str = '//*[@id="docContent"]/div/b/span/b/span/div[1]/table//a'
target_div_xpath_str = '//div[@id="main-content"]'
