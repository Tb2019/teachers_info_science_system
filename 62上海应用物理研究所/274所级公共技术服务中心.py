...
institute_name = '上海应用物理研究所'
laboratory_name = '所级公共技术服务中心'
institute_id = 62
laboratory_id = 274
img_url_head = None
partition_num = '021'
start_urls = ['https://sjzx.sinap.ac.cn/person/QueryPersons']

a_s_xpath_str = ''
target_div_xpath_str = '//div[@class="wrapperMiddle"]'


def get_info_from_ajax(url):
    payload = "name=&page=1&pagesize=50"
    headers = {
        ...
        'dnt': '1',
        'origin': 'https://sjzx.sinap.ac.cn',
        'pragma': 'no-cache',
        'priority': 'u=1, i',
        'referer': 'https://sjzx.sinap.ac.cn/person',
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for item in items:
            name = item['name']
            link = 'https://sjzx.sinap.ac.cn/person/info/?id=' + f'{item["id"]}'
            yield name, link
    ...
    def run(self):
        ...
        for url in self.start_urls:
            ...
            index_page = get_info_from_ajax(url)
