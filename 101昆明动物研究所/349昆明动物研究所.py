...
institute_name = '昆明动物研究所'
laboratory_name = '昆明动物研究所'
institute_id = 101
laboratory_id = 349
img_url_head = None
partition_num = '0871'
start_urls = [
                # 'https://kiz.cas.cn/rcjy/zgjgwry/',
                'https://kiz.cas.cn/rcjy/wrjh1/'
              ]

# a_s_xpath_str = '//div[@class="zyk_cent"]/div/div/div[@class="kiz_pi"]//a'
a_s_xpath_str = '//div[@style="width:1000px; margin-top:20px;overflow:hidden;"]/div/p/a'
target_div_xpath_str = '/html/body/div[3]/div/div[4]'
