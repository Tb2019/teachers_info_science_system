# -*- coding: utf-8 -*-
# todo:修改了util中的 get_format_result 方法，使得抓取列表页的图片。
import re
...
institute_name = '1物理研究所'
laboratory_name = '超导国家重点实验室'
institute_id = 1
laboratory_id = 1
img_url_head = None
partition_num = '010'
start_urls = [
                'https://nlsc.iphy.ac.cn/list_faculty.php?id=783',
                'https://nlsc.iphy.ac.cn/list_faculty.php?id=784',
                'https://nlsc.iphy.ac.cn/list_img_name.php?id=785'
              ]

a_s_xpath_str = '//div[@class="row add-link list_faculty_cont" or @class="row add-link"]/div[@class="col-sm-6 col-md-3"]//a'
target_div_xpath_str = '//div[@class="row info"]'
