...
laboratory_name = '系统控制重点实验室'
institute_id = 11
laboratory_id = 92
img_url_head = None
partition_num = '010'
start_urls = [
                'http://lsc.amss.cas.cn/kydw/zkyys/',
                'http://lsc.amss.cas.cn/kydw/yjy/',
                'http://lsc.amss.cas.cn/kydw/fyjy/',
                'http://lsc.amss.cas.cn/kydw/zlyjy/'
              ]

a_s_xpath_str = '//div[@class="list"]/table//td/a'
target_div_xpath_str = '/html'
