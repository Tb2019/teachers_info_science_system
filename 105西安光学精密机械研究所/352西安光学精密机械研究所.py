...
institute_name = '西安光学精密机械研究所'
laboratory_name = '西安光学精密机械研究所'
institute_id = 105
laboratory_id = 352
img_url_head = None
partition_num = '029'
start_urls = [
                'https://opt.cas.cn/gb2019/kydw/zj/',
                'https://opt.cas.cn/gb2019/kydw/zj/index_1.html',
                'https://opt.cas.cn/gb2019/kydw/zj/index_2.html',
              ]

a_s_xpath_str = '//div[@class="row staff"]//li//div[@class="txtinfo"]//a'
target_div_xpath_str = '//div[@class="indexbox1"]'
