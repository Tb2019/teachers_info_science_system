...
institute_name = '烟台海岸带研究所'
laboratory_name = '海岸带环境过程实验室'
institute_id = 52
laboratory_id = 244
img_url_head = 'http://ir.yic.ac.cn/register/eperson_pic/'
partition_num = '0535'
start_urls = [
                'https://yic.cas.cn/yjdw/yjy/',
                'https://yic.cas.cn/yjdw/fyjy/'
              ]

a_s_xpath_str = '//div[@id="xlmain"]//dl[4]//a'
