...
institute_name = '光电技术研究所'
laboratory_name = '光电技术研究所'
institute_id = 99
laboratory_id = 348
img_url_head = None
partition_num = '028'
start_urls = [
                'https://ioe.cas.cn/rcdw/yjy/',
                'https://ioe.cas.cn/rcdw/yjy/index_1.html',
                'https://ioe.cas.cn/rcdw/yjy/index_2.html',
              ]

a_s_xpath_str = '//ul[@class="team2-list clearfix"]/li'
target_div_xpath_str = '//section[@class="team2-detail-wrap w1200"]'
...
class SpecialSpider(ReCrawler):
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            name = a.xpath('.//strong[@class="tl2-name"]/text()')
            if name:
                name = ''.join(name)
