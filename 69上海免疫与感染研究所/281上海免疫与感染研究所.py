...
institute_name = '上海免疫与感染研究所'
laboratory_name = '上海免疫与感染研究所'
institute_id = 69
laboratory_id = 281
img_url_head = None
partition_num = '021'
start_urls = [
                'https://siii.cas.cn/rc/yjzz/',
                'https://siii.cas.cn/rc/yjzz/index_1.html',
                'https://siii.cas.cn/rc/yjzz/index_2.html',
                'https://siii.cas.cn/rc/fyjy/',
              ]

a_s_xpath_str = '//ul[@class="row row-w"]/li/div/div[@class="box-info"]/a[1]'
target_div_xpath_str = '//div[@class="personnel-details"]'
