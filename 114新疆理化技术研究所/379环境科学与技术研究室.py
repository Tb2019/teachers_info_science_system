...
institute_name = '新疆理化技术研究所'
laboratory_name = '环境科学与技术研究室'
institute_id = 114
laboratory_id = 379
img_url_head = None
partition_num = '0991'
start_urls = [
                'https://xjipc.cas.cn/SMT/kydw/yjy/',
                'https://xjipc.cas.cn/SMT/kydw/fyjy/',
                'https://xjipc.cas.cn/SMT/kydw/zl/',
                'https://xjipc.cas.cn/douxincun/kydw/yjry_douxincun/',
                'https://xjipc.cas.cn/douxincun/kydw/gcs_douxincun/'
              ]

a_s_xpath_str = '//ul[@class="people-list"]/li/a[2]'
target_div_xpath_str = '//div[@id="xlmain" or @class="xlmain"]'
