...
laboratory_name = '材料物理与化学研究室'
institute_id = 114
laboratory_id = 376
img_url_head = None
partition_num = '0991'
start_urls = [
                'https://xjipc.cas.cn/NTC/kydw_NTC/yjy2/',
                'https://xjipc.cas.cn/NTC/kydw_NTC/fyjy/',
                'https://xjipc.cas.cn/NTC/kydw_NTC/zlyjy/',
                'https://xjipc.cas.cn/NTC/kydw_NTC/gcs/',
              ]
