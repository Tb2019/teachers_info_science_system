...
institute_name = '上海硅酸盐研究所'
laboratory_name = '高性能陶瓷和超微结构国家重点实验室前沿基础研究部'
institute_id = 60
laboratory_id = 258
img_url_head = None
partition_num = '021'
start_urls = [
                'https://www.sic.cas.cn/rcjy/yjy/'
              ]

a_s_xpath_str = '//table[@class="wzdt zj_list"][2]//a'
target_div_xpath_str = '//div[@class="col-lg-12 col-md-12 col-sm-12 col-xs-12"]'
