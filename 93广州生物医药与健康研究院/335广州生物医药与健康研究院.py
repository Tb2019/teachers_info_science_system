...
institute_name = '广州生物医药与健康研究院'
laboratory_name = '广州生物医药与健康研究院'
institute_id = 93
laboratory_id = 335
img_url_head = None
partition_num = '020'
start_urls = [
                'https://gibh.cas.cn/gb_rcdw/gb_yjy/',
                'https://gibh.cas.cn/gb_rcdw/gb_fyjy/',
                'https://gibh.cas.cn/gb_rcdw/gb_kzyjy/',
                'https://gibh.cas.cn/gb_rcdw/gb_gjjszcry/'
              ]

a_s_xpath_str = '//div[@class="row row-w"]/div/div/a'
target_div_xpath_str = '//div[@class="right-main"]'
