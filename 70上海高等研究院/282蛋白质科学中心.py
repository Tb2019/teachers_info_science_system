# -*- coding: utf-8 -*-
# todo:修改util中的result的phone和emial
import csv
import os
import re
import time
...
institute_name = '上海高等研究院'
laboratory_name = '蛋白质科学中心'
institute_id = 70
laboratory_id = 282
img_url_head = None
partition_num = '021'
start_urls = [
                'https://www.ncpss.org.cn/dictionary.action?lang=cn',
              ]

a_s_xpath_str = '//div[@class="dictionary_box"]//ul/li/a'
target_div_xpath_str = '//div[@class="contactb mg1000"]'
    ...
    def parse_index(self, index_page, url):
        ...
        for a in a_s:
            ...
            if name:
                ...
                try:
                    phone = a.xpath('./span[3]/text()')[0]
                    phone = re.sub('Tel：', '', phone)
                except:
                    phone = None
                try:
                    email = a.xpath('./span[2]/text()')[0]
