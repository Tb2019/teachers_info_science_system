...
institute_name = '遗传与发育生物学研究所'
laboratory_name = '遗传与发育生物学研究所'
institute_id = 31
laboratory_id = 178
img_url_head = None
partition_num = '010'
start_urls = [
                'https://genetics.cas.cn/yjdw/',
                # '',
                # '',
                # ''
              ]

a_s_xpath_str = '//div[@class="other-team"]/div/ul/li//div[@class="txtinfo"]/h4/a'
target_div_xpath_str = '//div[@class="text nrhei"]'
